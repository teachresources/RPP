...
`echo` and `eval` are not the only arguments that you can use to customize code chunks. You can learn more about formatting the output of code chunks at the [rmarkdown](https://bookdown.org/yihui/rmarkdown/r-code.html) and [knitr](http://yihui.name/knitr/options) websites.
...
Visit [rmakdown.rstudio.com](https://bookdown.org/yihui/rmarkdown/html-document.html) to learn about more YAML options that control the render process.
...
In the next article, [Introduction to interactive documents](http://shiny.rstudio.com/interactive-docs.html), you will learn how to add interactive Shiny components to an R Markdown report. This creates a quick workflow for writing light-weight Shiny apps.
