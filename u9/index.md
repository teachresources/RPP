...
information contained in a large multivariate data sets. The following
figure illustrates the type of analysis to be performed depending on the
type of variables contained in the data set.
...
individuals/variables:
    ...
    res.pca <- PCA(decathlon.active, graph = TRUE, scale.unit = TRUE)
...
![](pca_files/figure-markdown_strict/unnamed-chunk-35-6.svg)
